...
exports.MidnightExpress = void 0;
var tsyringe_1 = require("tsyringe");
var me_action_result_1 = require("./me-action-result");
var me_router_core_1 = require("./me-router-core");
var me_middleware_1 = require("../middleware/me.middleware");
var me_request_middleware_1 = require("../middleware/me-request.middleware");
var bodyParser = __importStar(require("body-parser"));
var express_1 = require("express");
var express_2 = __importDefault(require("express"));
var cors_1 = __importDefault(require("cors"));
var MidnightExpress = /** @class */ (function () {
    function MidnightExpress(routerCore) {
        ...
        this.serverApp.use(me_middleware_1.meMiddleware);
        this.serverApp.use(me_request_middleware_1.meRequestMiddleware);
     ...
     * @returns {IZynServer}
     */
    MidnightExpress.prototype.setCors = function (path) {
        if (path === void 0) { path = "*"; }
        this.webRoutes.use((0, cors_1.default)());
        this.webRoutes.options(path, (0, cors_1.default)());
        return this;
    };
    MidnightExpress.prototype.json = function () {
        this.webRoutes.use(bodyParser.json());
        return this;
    };
    MidnightExpress.prototype.setViewEngine = function (name) {
        this.serverApp.set("view engine", name);
        return this;
    };
    MidnightExpress.prototype.setStaticRoot = function (rootPath) {
        this.serverApp.use(express_2.default.static(rootPath));
        return this;
    };
    MidnightExpress.prototype.setStaticAlias = function (alias, path) {
        this.serverApp.use(express_2.default.static('template'));
        this.serverApp.use(alias, express_2.default.static(path));
        return this;
    };
    MidnightExpress.prototype.registerMiddleware = function (middleware) {
        this.serverApp.use(middleware);
        return this;
    };
    MidnightExpress.prototype.registerController = function (controller) {
        try {
     ...
     */
    MidnightExpress.prototype.registerControllers = function (controllers) {
     ...
     * @param {string} host
     * @param port
     * @returns {Promise<MeActionResult>}
     */
    MidnightExpress.prototype.start = function (host, port) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (isNaN(port)) {
                            return [2 /*return*/, me_action_result_1.MeActionResult.new().setError("Invalid port")];
                        }
                        result = me_action_result_1.MeActionResult.new();
    ...
    MidnightExpress = __decorate([
        (0, tsyringe_1.singleton)(),
        __metadata("design:paramtypes", [me_router_core_1.MeRouterCore])
    ], MidnightExpress);
    return MidnightExpress;
}());
exports.MidnightExpress = MidnightExpress;
//# sourceMappingURL=zynaptic-web.js.map
